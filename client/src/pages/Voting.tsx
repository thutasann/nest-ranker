  ...
  return (
    <div className="mx-auto flex flex-col w-full justify-between items-center h-full max-w-sm">
      <div className="w-full">
        <h1 className="font-bold text-center mb-3">Voting ✅</h1>
      </div>
      <div className="w-full">
        {currentState.poll ? (
          <>
            ...
            <div className="text-center text-indigo-700 text-lg font-semibold mb-6">
      ...
      <div className="px-2">
        {Object.entries(currentState.poll?.norminations || {}).map(
          ([id, nomination]) => (
            <RankedCheckBox
              key={id}
